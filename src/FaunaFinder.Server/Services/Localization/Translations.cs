...
public static class Translations
{
    public static IReadOnlyDictionary<string, string> English { get; } =
        new Dictionary<string, string>
        {
            ...
            ["GetStarted_StudentFeature1"] = "Report Sightings",
            ["GetStarted_StudentFeature2"] = "Explore Species",
            ["GetStarted_StudentFeature3"] = "Learn Conservation",
            ["GetStarted_StudentFeature4"] = "Track Progress",
    ...
    public static IReadOnlyDictionary<string, string> Spanish { get; } =
        new Dictionary<string, string>
        {
            ...
            ["GetStarted_StudentFeature1"] = "Reportar Avistamientos",
            ["GetStarted_StudentFeature2"] = "Explorar Especies",
            ["GetStarted_StudentFeature3"] = "Aprender Conservación",
            ["GetStarted_StudentFeature4"] = "Seguir Progreso",
