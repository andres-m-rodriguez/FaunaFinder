...
public static class ExportEndpoints
{
    public static void MapExportEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group
            .MapGet(
                "/municipality/{municipalityId:int}/pdf",
                async (
                    int municipalityId,
                    string? speciesIds,
                ...
                {
                    var municipality = await municipalityRepository.GetMunicipalityDetailAsync(
                        municipalityId,
                        ct
                    );
                    ...
                    var species = await speciesRepository.GetSpeciesByMunicipalityAsync(
                        municipalityId,
                        ct
                    );
                    ...
                    var pdfBytes = reportService.GeneratePdfReport(
                        municipality.Name,
                        species.ToList()
                    );
        ...
        group
            .MapGet(
                "/municipality/{municipalityId:int}/csv",
                async (
                    int municipalityId,
                    string? speciesIds,
                    IMunicipalityRepository municipalityRepository,
                ...
                ) =>
                {
                    ...
                    var csvBytes = reportService.GenerateCsvReport(
                        municipality.Name,
                        species.ToList()
                    );
