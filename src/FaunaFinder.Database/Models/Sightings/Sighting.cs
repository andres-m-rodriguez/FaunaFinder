...
public sealed class Sighting
{
    ...
    public sealed class EntityConfiguration : IEntityTypeConfiguration<Sighting>
    {
        public void Configure(EntityTypeBuilder<Sighting> builder)
        {
            ...
            builder.HasOne(static e => e.ReportedByUser)
                .WithMany()
                .HasForeignKey(static e => e.ReportedByUserId)
                .OnDelete(DeleteBehavior.Restrict);

            builder.HasOne(static e => e.ReviewedByUser)
                .WithMany()
                .HasForeignKey(static e => e.ReviewedByUserId)
                .OnDelete(DeleteBehavior.Restrict);
