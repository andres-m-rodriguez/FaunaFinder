...
public interface ISightingRepository
{
    ...
    Task<SightingsPage> GetSightingsByUserAsync(
    ...
    Task<SightingPhotoResult?> GetSightingPhotoAsync(
        int sightingId,
        CancellationToken cancellationToken = default
    );
    ...
    Task<(bool Success, string? Error)> ReviewSightingAsync(
        int sightingId,
        ReviewSightingRequest request,
        int reviewerUserId,
        CancellationToken cancellationToken = default
    );
    Task<(bool Success, string? Error)> UpdateSightingPhotoAsync(
        int sightingId,
        int userId,
        byte[] photoData,
        string contentType,
