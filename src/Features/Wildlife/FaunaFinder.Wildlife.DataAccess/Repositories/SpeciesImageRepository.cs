...
public sealed class SpeciesImageRepository(IDbContextFactory<WildlifeDbContext> contextFactory)
    : ISpeciesImageRepository
{
    ...
    )
    {
        ...
        return await context
            ...
            .Where(s =>
                s.Id == speciesId && s.ProfileImageData != null && s.ProfileImageContentType != null
            )
    ...
    )
    {
        ...
        var rowsAffected = await context
            .Species.Where(s => s.Id == speciesId)
            .ExecuteUpdateAsync(
                s =>
                    s.SetProperty(sp => sp.ProfileImageData, imageData)
    ...
    )
    {
        ...
        var rowsAffected = await context
            ...
            .ExecuteUpdateAsync(
                s =>
                    s.SetProperty(sp => sp.ProfileImageData, (byte[]?)null)
