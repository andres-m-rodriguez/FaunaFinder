...
namespace FaunaFinder.Wildlife.Database.Migrations
{
    ...
    public partial class InitialWildlife : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    scientific_name = table.Column<string>(
                        type: "character varying(200)",
                        maxLength: 200,
                        nullable: false
                    ),
                    profile_image_data = table.Column<byte[]>(type: "bytea", nullable: true),
                    profile_image_content_type = table.Column<string>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    common_name = table.Column<string>(
                        type: "character varying(200)",
                        maxLength: 200,
                        nullable: false
                    ),
                    ...
                    photo_content_type = table.Column<string>(
                        type: "character varying(100)",
                        maxLength: 100,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    observed_at = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
                    created_at = table.Column<DateTime>(
                    ...
                    audio_content_type = table.Column<string>(
                        type: "character varying(100)",
                        maxLength: 100,
                        nullable: true
                    ),
                    ...
                    is_new_municipality_record = table.Column<bool>(
                        type: "boolean",
                        nullable: false
                    ),
                    review_notes = table.Column<string>(
                        type: "character varying(2000)",
                        maxLength: 2000,
                        nullable: true
                    ),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "species_locations");

            migrationBuilder.DropTable(name: "user_species");
