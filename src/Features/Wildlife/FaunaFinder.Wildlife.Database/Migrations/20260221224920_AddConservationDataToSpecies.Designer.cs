...
namespace FaunaFinder.Wildlife.Database.Migrations
{
    ...
    [Migration("20260221224920_AddConservationDataToSpecies")]
    partial class AddConservationDataToSpecies
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FaunaFinder.Wildlife.Database.Models.FwsAction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FaunaFinder.Wildlife.Database.Models.FwsLink", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("FaunaFinder.Wildlife.Database.Models.Municipality", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("FaunaFinder.Wildlife.Database.Models.MunicipalitySpecies", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("FaunaFinder.Wildlife.Database.Models.NrcsPractice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("FaunaFinder.Wildlife.Database.Models.FwsLink", b =>
                {
                    b.HasOne("FaunaFinder.Wildlife.Database.Models.FwsAction", "FwsAction")
                        .WithMany("FwsLinks")
                        .HasForeignKey("FwsActionId")
                    ...
                    b.HasOne("FaunaFinder.Wildlife.Database.Models.NrcsPractice", "NrcsPractice")
                        .WithMany("FwsLinks")
                    ...
                    b.OwnsMany("FaunaFinder.i18n.Contracts.LocaleValue", "Justification", b1 =>
                        {
                            b1.Property<int>("FwsLinkId");
            ...
            modelBuilder.Entity("FaunaFinder.Wildlife.Database.Models.MunicipalitySpecies", b =>
                {
                    b.HasOne("FaunaFinder.Wildlife.Database.Models.Municipality", "Municipality")
            ...
            modelBuilder.Entity("FaunaFinder.Wildlife.Database.Models.NrcsPractice", b =>
                {
                    b.OwnsMany("FaunaFinder.i18n.Contracts.LocaleValue", "Name", b1 =>
                        {
                            b1.Property<int>("NrcsPracticeId");
